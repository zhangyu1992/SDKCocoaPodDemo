...
Pod::Spec.new do |s|
 ...
 Testing Private Podspec.
  ...
  # Or just: s.author    = "zhangyu1992"
  # s.authors            = { "zhangyu1992" => "zy334451241@sina.com" }
  # s.social_media_url   = "http://twitter.com/zhangyu1992"
  ...
  s.source       = { :git => "https://github.com/zhangyu1992/SDKCocoaPodDemo.git", :tag => "1.0.10" }
